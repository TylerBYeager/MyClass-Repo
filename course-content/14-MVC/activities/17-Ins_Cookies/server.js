...
const sess = {
  ...
  //Adding cookie settings allows us to change the settings that are associated with the cookie that gets sent to the client. This cookie gets sent to the client immediately after express-session is added to the server, allowing us to store information about the session on the user's client. 
  //We can update the cookie settings to change how the session is identified on the server whenever sessions are used.
...
//URI Encoding: s%3
// Session ID: U-jhz9ferT3VptnCJKDPn_MhNxX1VKIF
// Server Side: 
// s%3AU-jhz9ferT3VptnCJKDPn_MhNxX1VKIF.lZpl9dUzIXiaaNw0kDgbhzqWWmdZzDWFRVzGcx2%2F6J8
