...
// 🔑 We then assign values for both a secret and expiration. The secret is a private key that signs the token and enables the server to verify whether the token is valid. 
