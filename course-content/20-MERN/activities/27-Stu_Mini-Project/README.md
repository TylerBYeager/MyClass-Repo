...
React Router recently upgraded to version 6 which includes breaking changes with <Switch>, <Redirect> and other elements. This activitiy uses React Router version 5. Please se this npm command to install React Router version 5: npm install react-router-dom@5.
